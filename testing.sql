...
--
-- Table structure for table `matches_sid`
--

DROP TABLE IF EXISTS `matches_sid`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `matches_sid` (
  `match_id` bigint(20) NOT NULL,
  `sid_id` bigint(20) NOT NULL,
  UNIQUE KEY `UK_tcx83lig6bsp78m93hx3duefr` (`sid_id`),
  KEY `FK5b86rlwgjdpmpx17cxkfjk19x` (`match_id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `matches_sid`
--

LOCK TABLES `matches_sid` WRITE;
/*!40000 ALTER TABLE `matches_sid` DISABLE KEYS */;
/*!40000 ALTER TABLE `matches_sid` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `mteam` VALUES (1,0,'Myteam'),(2,1,'Myteam1');
...
INSERT INTO `series` VALUES (1,'2019-01-10 23:44:08','test','xyz','2019-01-10 23:44:08',11);
...
CREATE TABLE `series_team_link_m_team` (
  ...
  KEY `FKjktao162j45kquh0qo894ul5` (`m_team_id`),
...
CREATE TABLE `series_team_link_series` (
  ...
  KEY `FK9daf4xjo0ma1ngxal9jp4o6du` (`series_id`),
...
-- Dump completed on 2019-01-11  0:35:17
